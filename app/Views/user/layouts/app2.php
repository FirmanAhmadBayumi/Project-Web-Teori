    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#modul" style="color: black">SiProfit</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#solve" style="color: black">Our Services</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#contact" style="color: black">Login</a>
                </li>
            </ul>
        </div>
    </nav>
